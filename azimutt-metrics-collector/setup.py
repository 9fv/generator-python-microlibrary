...
download_url = 'https://github.com/azimutt-io/azimutt-metrics-collector/archive/v%s.tar.gz' % CONFIGURATION['version']
...
setup(name='%s' % (CONFIGURATION['name']),
      ...
      url='http://github.com/azimutt-io/azimutt-metrics-collector',
